class Sinkzone < Formula
  ...
  def post_install
    ...
    if OS.mac?
      ...
      plist_file = "#{plist_dir}/com.berbyte.sinkzone.resolver.plist"
      ...
      unless File.exist?(plist_file)
        File.write(plist_file, <<~EOS)
          ...
          <dict>
              <key>Label</key>
              <string>com.berbyte.sinkzone.resolver</string>
  ...
  def caveats
    ...
    if OS.linux?
      ...
      caveats_text += <<~EOS
        ...
        - Enable service: sudo launchctl load /Library/LaunchDaemons/com.berbyte.sinkzone.resolver.plist
        - Stop service: sudo launchctl unload /Library/LaunchDaemons/com.berbyte.sinkzone.resolver.plist
